  ...
  router.put("/:id/guilds/:guildId/config", async (req, res, next) => {
    ...
    try {
      ...
      const fields: Omit<GuildConfig, "guildId" | "createdAt" | "updatedAt"> = {
        ...
        whitelistApprovedChannelId: String(body.whitelistApprovedChannelId ?? body.whitelist_approved_channel_id ?? ""),
        whitelistRejectedChannelId: String(body.whitelistRejectedChannelId ?? body.whitelist_rejected_channel_id ?? ""),
        whitelistRoleId:       String(body.whitelistRoleId ?? body.whitelist_role_id ?? ""),
        whitelistRejectedRoleId: String(body.whitelistRejectedRoleId ?? body.whitelist_rejected_role_id ?? ""),
